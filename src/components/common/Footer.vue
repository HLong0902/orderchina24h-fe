...
export default {
  ...
  mounted() {
    ...
    (function (d, s, id) {
      ...
      js.id = id;
      js.src =
        "https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v13.0&appId=YOUR_APP_ID&autoLogAppEvents=1";
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="row">
                ...
                <div class="widget-menu-1 flex-50">
                  ...
                  <div class="menu-ve-chung-toi-container">
                    <ul id="footer-menu-1" class="footer-menu-1 list-style-type">
                      ...
                      >
                        <router-link to="/danh-muc-chinh-sach"
                      ...
                      >
                        <router-link to="/danh-muc-chinh-sach"
                          >Chính Sách Khiếu Nại</router-link
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <div class="widget-menu-2 flex-50">
                  ...
                  <div class="menu-cham-soc-khach-hang-container">
                    <ul id="footer-menu-2" class="footer-menu-2 list-style-type">
                      ...
                      >
                        <router-link
                          to="/huong-dan-tai-va-dang-ky-tai-khoan-tai-app-mua-hang-trung-quoc-nhchina-nhap-hang-china"
                      ...
                      >
                        <router-link
                          to="/huong-dan-tai-va-dang-ky-tai-khoan-tai-app-mua-hang-trung-quoc-nhchina-nhap-hang-china"
                          >Hướng dẫn tạo tài khoản</router-link
                        >
                      </li>
                      <li
                        id="menu-item-300"
                      ...
                      >
                        <router-link
                          to="/huong-dan-tai-va-dang-ky-app-mua-hang-trung-quoc-nhap-hang-china-tren-ios"
                      ...
                      >
                        <router-link to="/danh-muc-chinh-sach"
                          >Trả hàng &amp; vận chuyển</router-link
                        >
                      </li>
                    </ul>
                  </div>
              ...
              <div class="footer-socials col-12">
                <a
                  href="https://www.facebook.com/profile.php?id=100090809792385"
                  rel="nofollow"
                  target="_blank"
                >
          ...
          <div class="col-12 col-md-12 col-lg-4">
            <div class="widget-fanpage">
              <div
                ...
                data-href="https://www.facebook.com/profile.php?id=100090809792385"
                data-tabs="messages"
                data-width="561"
                data-height="305"
              ...
              >
                <span style="vertical-align: bottom; width: 370px; height: 305px"
                  ><iframe
                    name="f12df3bb39af9e697"
                    width="561px"
                    height="305px"
            ...
            <div class="widget-extension">
              <div class="extension-content">
                <div class="extension-item">
                  <a
                    href="https://chromewebstore.google.com/detail/extension-order-china-24h/olhhmicighhhfokcaafaagokgpdhmoch?hl=en-US&utm_source=ext_sidebar"
                    title="Extension Google Chrome"
                    target="_blank"
                    rel="nofollow"
                  >
                    <img src="/chrome.png" alt="Extension Google Chrome" />
                    <span class="txt"
                      >Tải về cho trình duyệt <br /><b>Google Chrome</b></span
                    >
                  </a>
                </div>
                <div class="extension-item">
