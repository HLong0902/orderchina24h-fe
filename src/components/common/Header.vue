...
<template>
  <!-- header cho laptop -->
  <header class="header-nav navbar" id="header">
          ...
          <div class="header-top-left col-12 col-md-6">
            <div class="exchange-rate">
              ...
              <p>
                Tỷ giá:
                <span>{{
                  (commonStore.exchange_rate / 1000).toFixed(3).replace(".", ",")
                }}</span>
              </p>
            </div>
            <div class="hotline">
          ...
          <div class="header-right col-4 col-md-9">
            <b-navbar class="header-menu">
              <b-navbar-nav id="main-menu" class="main-menu">
                ...
                >
                  <router-link to="/gioi-thieu-ve-nhap-hang-china"
                ...
                >
                  <b-dropdown-item title="Hướng dẫn đặt hàng" class="active">
                    <router-link
                      ...
                      >Hướng dẫn đặt hàng</router-link
                    >
                  </b-dropdown-item>
