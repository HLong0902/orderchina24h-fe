...
<template>
	<div id="content" class="clearfix fullwidth">
		<div class="lists_ship clearfix">
			<h2 class="float-left">Cấu hình bảng giá ký gửi</h2>
		</div>
		<br>
		<div>
			<div class="row">
						...
						<div class="entry-content clearfix">
							<div class="wrap-bang-gia">
								<div class="mys-item-table">
									<h2>1. Chi phí một đơn hàng ký gửi</h2>
												...
												<tr v-for="(item, idx) in DEPOSIT_SHIP_SINGLE">
													...
													<td>
														<input @keyup.enter.prevent="updateItemValue(item)" type="text"
															v-model="item.value" size="9">&nbsp;<sup>đ/kg</sup>
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table class="mys-table">
											...
											<tbody>
												<tr v-for="(item, idx) in DEPOSIT_BULK_GOODS">
													...
													<td>
														<input @keyup.enter.prevent="updateItemValue(item)" type="text"
															v-model="item.value" size="9">&nbsp;<sup>đ/m3</sup>
													</td>
												</tr>
											</tbody>
										</table>
...
<script>
export default {
	name: "StaffPriceDepositConfigSection",
	data() {
		return {
