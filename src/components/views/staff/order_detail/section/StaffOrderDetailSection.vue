                      ...
                      >
                        ...
                        <div>
                          <span v-for="(item, idx) in commonStore.service_fee">
                            ...
                            <br
                              v-if="idx != commonStore.service_fee.length - 1"
                            />
                          </span>
                        </div>
                      </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    NDT) /
                    <span class="red big"
                      >{{ order.orderChina.totalProduct }} SP</span
                    >
                  </td>
                </tr>
            ...
            <tr>
              <td>
                <span>
                  ...
                  <a
                    class="button-link"
                    @click="handlepurchaseFee(order.orderChina)"
                    >Lưu</a
                  >
                </span>
              </td>
              <td>
                <span>
                  ...
                  <a
                    class="button-link"
                    @click="handleShippingPrice(order.orderChina)"
                    >Lưu</a
                  >
                </span>
              </td>
              <td>
                <span>
                  <input
                    v-model="order.orderChina.exchangeRate"
                  ...
                  <a
                    class="button-link"
                    @click="handleExchangeRate(order.orderChina)"
                    >Lưu</a
                  >
                </span>
              </td>
              <td>
                <span>
                  ...
                  &nbsp;
                  <a class="button-link" @click="handleStatus(order.orderChina)"
                    >Lưu</a
                  >
                </span>
              </td>
        ...
        <div class="cu-row">
          ...
          <table class="table borderless no_margin">
            <tbody>
              ...
              <tr
                v-if="CommonUtils.getRole() != CONSTANT.ROLE.NHAN_VIEN_MUA_HANG"
              >
        ...
        <div class="cu-row" v-if="CommonUtils.getRole() == CONSTANT.ROLE.ADMIN">
          ...
          <div class="col-md-12">
            <div class="button_confirm clearfix">
              <a class="button-link special-green" @click="handleSettleOrder"
                >Tất toán đơn hàng >></a
              >
              &nbsp;
              <a
        ...
        <table>
          <tbody>
            ...
            <tr v-for="(detail, index) in order.orderDetails" class="">
              ...
              <td>
                ...
                <div class="info">
                  ...
                  <p>
                    ...
                    >
                    <a
                      class="button-link button_special"
                      v-if="detail.status == 0"
              ...
              <td>
                <p>
                  <strong>SL Yêu cầu: {{ detail.numberItem }}</strong>
                </p>
                <input
                  v-if="
                    CommonUtils.getRole() == CONSTANT.ROLE.ADMIN ||
              ...
              <td v-if="index == 0" rowspan="4" class="specials">
                ...
                >
                  ...
                  <input
                    ...
                    @keyup.enter.prevent="addCompanyPayment"
                    class="label_edit"
                  />
                ...
                >
                  <div class="vandon_form">
                    ...
                    />
                    <a class="button-link" @click="appendOrderShopCode()"
                      >Thêm</a
                    >
                  </div>
                </form>
              ...
              <tbody>
                ...
                <tr v-for="(pkg, index) in packages">
                  ...
                  <td>
                    <span
                      :class="
                        CommonUtils.promptPackageStatusClassByValue(pkg.status)
                      "
                    >
                      {{
            ...
            <table>
              <tbody>
                ...
                <tr v-for="(transaction, index) in order.transactionHistory">
                  ...
                  <td>
                    <span v-if="transaction.type == 4" class="green bold"
                      >+</span
                    >
    ...
    async handleShippingPrice(orderChina) {
      ...
      const payload = {
        ...
        shippingPrice: parseFloat(
          CommonUtils.removeCommas(orderChina.shippingPrice),
        ),
      };
      const res = await ApiCaller.post(ROUTES.Order.updateFee, payload);
      if (res.status == 200) {
    ...
    async handleExchangeRate(orderChina) {
      ...
      const payload = {
        ...
        exchangeRate: parseFloat(
          CommonUtils.removeCommas(orderChina.exchangeRate),
        ),
      };
      const res = await ApiCaller.post(ROUTES.Order.updateFee, payload);
      if (res.status == 200) {
