...
<template>
  <section
    class="price-list-wrapper enable-gradient"
    style="background-image: url(/partner.jpg)"
  >
    <div class="container">
      <div class="row">
          ...
          <div class="price-list-content row">
            <div class="conteent-right col-12 col-md-8">
              <div class="row">
                <div class="col-12 col-sm-6 step step-1">
                  <div class="step-item">
                    <div class="step-icon">
                      ...
                      ><span class="outer-circle outer-delay"></span
                      ><span class="step-number">1</span>
                    </div>
                    <div class="step-name">
                      <h4>TIỀN HÀNG TRÊN WEB</h4>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6 step step-2">
                  <div class="step-item">
                    <div class="step-icon">
                      <span class="outer-circle"></span
                      ><span class="outer-circle outer-delay"></span
                    ...
                    <div class="step-name">
                      <h4>PHÍ SHIP TRUNG QUỐC</h4>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6 step step-3">
                  <div class="step-item">
                    <div class="step-icon">
                      <span class="outer-circle"></span
                      ><span class="outer-circle outer-delay"></span
                ...
                <div class="col-12 col-sm-6 step step-4">
                  <div class="step-item">
                    <div class="step-icon">
                      <span class="outer-circle"></span
                      ><span class="outer-circle outer-delay"></span
                    ...
                    <div class="step-name">
                      <h4>CƯỚC VẬN CHUYỂN</h4>
                    </div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="btn-more">
                    <a href="/bang-gia-van-chuyen/">Chi Tiết Bảng Giá</a>
                  </div>
                </div>
              </div>
            </div>
