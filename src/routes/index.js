...
import StaffTransactionDetailPage from "../components/views/staff/transaction/details/StaffTransactionDetailPage.vue";
...
const staff_routes = {
  ...
  children: [
    ...
    {
      path: "transaction/:id",
      name: "StaffTransactionDetailPage",
      component: StaffTransactionDetailPage,
      beforeEnter: (to, from, next) =>
        RouteGuard.staffGuard(to, from, next, [CONSTANT.ROLE.ADMIN]),
    },
    {
